...
DATA_GRID_LAND_USE = "germany/CropLandcoverMap_1000_gk5.asc"
...
GEO_TARGET_GRID="epsg:5835" #proj4 -> 3-degree gauss-kruger zone 5 (=Germany) https://epsg.io/31469
        ...
        for srow in range(0, srows):
            ...
            for scol in range(0, scols):
                ...
                if len(sp_json) == 0:
                    ...
                    continue
                #if soil_id < 1 or soil_id > 71: # to check for buek1000 profile ids
                    #print("row/col:", srow, "/", scol, "has unknown soil_id:", soil_id)
                    #unknown_soil_ids.add(soil_id)
                #    continue
                ...
                if setup["landcover"]:
                    ...
                    if corine_id not in [2, 3, 4, 5, 6, 7, 8]:
                        continue
