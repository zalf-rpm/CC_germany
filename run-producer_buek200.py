...
#TEMPLATE_PATH_LATLON = "{path_to_climate_dir}{climate_data}/latlon-to-rowcol.json"
TEMPLATE_PATH_LATLON = "/beegfs/common/data/climate/dwd/cmip_cordex_reklies/latlon-to-rowcol.json"
